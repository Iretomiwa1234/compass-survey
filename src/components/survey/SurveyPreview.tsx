          ...
          <div className="flex flex-col gap-2 py-4 px-6">
            {questions.length === 0 ? (
              ...
              <div className="space-y-3">
                {questions.map((q, idx) => (
                  <div key={q.id}>
                    <div
                      ...
                      className={`rounded-md border border-dashed transition-all duration-150 ${
                        hoverIndex === idx
                          ? "h-6 border-[#206AB5] bg-[#E8F0FB]"
                    ...
                    >
                      ...
                      <div className="p-4">
                        {q.type === "rating" ? (
                          ...
                          >
                            <option value="">
                              {q.placeholder ?? "Search locations..."}
                            </option>
                            {(q.locations ?? []).map((location, optionIdx) => (
                              <option
                                key={`${q.id}-location-${optionIdx}`}
                                value={location}
                              >
                                {location}
                              </option>
                ...
                <div
                  onDragOver={handleDragOver}
                  onDragEnter={() => setHoverIndex(questions.length)}
                  onDragLeave={() => setHoverIndex(null)}
                  onDrop={(e) => handleDropAt(e, questions.length)}
                  className={`rounded-md border border-dashed transition-all duration-150 ${
                    hoverIndex === questions.length
                      ? "h-6 border-[#206AB5] bg-[#E8F0FB]"
                      : "h-2 border-transparent"
                  }`}
                />

...
import { Users, Edit, Trash2, MessageSquare, TrendingUp, Smile, Award } from "lucide-react";
import {
  Pagination,
  PaginationContent,
  PaginationEllipsis,
            ...
            <div className="mb-6">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="w-full">
                        ...
                        <p className="text-xs text-green-600 mt-2">+23% vs last week</p>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0 rounded-full hover:bg-blue-50">
                      ...
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0 rounded-full hover:bg-pink-50">
                      ...
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0 rounded-full hover:bg-gray-100">
                        <svg className="w-4 h-4 text-foreground" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                      </Button>
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0 rounded-full hover:bg-blue-50">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative w-20 h-20">
                            <svg className="w-full h-full transform -rotate-90">
                              ...
                              <circle cx="40" cy="40" r="35" fill="none" stroke="hsl(142 76% 36%)" strokeWidth="8" strokeDasharray="220" strokeDashoffset="88" strokeLinecap="round"/>
                            </svg>
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <Button className="gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" strokeWidth="2"/><path strokeLinecap="round" strokeWidth="2" d="M12 8v8M8 12h8"/></svg>
                  Create new project
                </Button>
              </div>
